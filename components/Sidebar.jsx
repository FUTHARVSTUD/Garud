...
const Sidebar = () => {
  ...
  return (
    <aside id="default-sidebar" className="relative sm:block  hidden top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0">
   ...
   <div className="flex items-center gap-4">
      <img className="w-10 h-10 rounded-full" src="https://png.pngtree.com/png-clipart/20210915/ourlarge/pngtree-avatar-placeholder-abstract-white-blue-green-png-image_3918476.jpg" alt=""/>
      <div className="font-medium dark:text-white">
         <div>Samarth Mishra</div>
         <div className="text-sm text-gray-500 dark:text-gray-400">Garud Object Detection</div>
      </div>
   </div>
